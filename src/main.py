...
import numpy as np
import mpmath
# extended / analytically continued Reimann Zeta Function
"""def reimann_zeta(s, precision, sumterms=100):
    mpmath.mp.dps = precision
    return mpmath.nsum(lambda n: 1 / (n ** s), [1, mpmath.inf], method="euler-mclaurin", terms=sumterms)
"""
...
if __name__ == "__main__":
    ...
    yvals = [reimann_zeta(complex(0.5, x), 30).real for x in xvals]
